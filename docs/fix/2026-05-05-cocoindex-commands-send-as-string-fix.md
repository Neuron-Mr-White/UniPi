...
## Notes
- The register-extension chore doc (`docs/chore/register-extension.md`) documents all required registration points. The cocoindex package had most of them done correctly — only the npm install and all-in-one entry were missing.
