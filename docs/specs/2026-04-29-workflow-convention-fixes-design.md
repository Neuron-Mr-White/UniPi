...
10. No `docs/research/` or `docs/context-gathered/` directories
...
- `docs/research/` — research reports from `/unipi:research`
- `docs/context-gathered/` — gathered context from `/unipi:gather-context`
