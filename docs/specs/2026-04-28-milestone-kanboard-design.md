...
- Docs are stored in `docs/{specs,plans,quick-work,debug,fix,chore,reviews}/`
...
*Session Start:*
1. Check if `docs/MILESTONES.md` exists
...
|----------|----------|-----------------|
| Brainstorm specs | `docs/specs/` | `- [ ]` and `- [x]` checklist items |
| Plans | `docs/plans/` | `unstarted:`, `in-progress:`, `completed:` task statuses |
| MILESTONES | `docs/MILESTONES.md` | Phase headers + `- [ ]` items |
| Quick-work | `docs/quick-work/` | Summary of what was done |
| Debug reports | `docs/debug/` | Bug descriptions + status |
| Fix reports | `docs/fix/` | What was fixed |
| Chores | `docs/chore/` | Chore definitions |
| Reviews | `docs/reviews/` | Review remarks |
