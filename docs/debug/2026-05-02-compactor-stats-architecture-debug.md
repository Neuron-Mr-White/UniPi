...
- The previous fix (`docs/fix/2026-05-02-compactor-stats-always-zero-fix.md`) addressed session ID mismatches and tokensBefore path, but the stats are STILL zero — suggesting the root cause is deeper
