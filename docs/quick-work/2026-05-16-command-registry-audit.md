...
- `docs/chore/full-release.md`, `docs/chore/register-extension.md`: replaced fragile manual command-registry checks with the new audit test in release/registration chores.
