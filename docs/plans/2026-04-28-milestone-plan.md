...
specs:
  - docs/specs/2026-04-28-milestone-kanboard-design.md
---
...
- **Acceptance Criteria:**
  ...
  - Reads MILESTONES.md from `docs/MILESTONES.md`
...
- **Acceptance Criteria:**
  ...
  - Scans `docs/{specs,plans,quick-work}/` for files modified since session start
...
- **Steps:**
  ...
  2. Write Phase 1 (Explore): Scan `docs/` for existing specs, plans, quick-work, debug, fix, chore docs. List what's been done vs. what's planned.
...
- **Steps:**
  ...
  2. Write Phase 1 (Scan): Read all docs in `docs/` directories. Filter by modification time.
