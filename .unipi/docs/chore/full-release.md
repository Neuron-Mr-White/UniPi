...
|-----------|-------------|----------|
| `packages/ask-user` | `@pi-unipi/ask-user` | 2.1.2 |
| `packages/autocomplete` | `@pi-unipi/command-enchantment` | 2.1.2 |
| `packages/btw` | `@pi-unipi/btw` | 2.1.2 |
| `packages/cocoindex` | `@pi-unipi/cocoindex` | 2.1.2 |
| `packages/compactor` | `@pi-unipi/compactor` | 2.1.2 |
| `packages/core` | `@pi-unipi/core` | 2.1.2 |
| `packages/footer` | `@pi-unipi/footer` | 2.1.2 |
| `packages/info-screen` | `@pi-unipi/info-screen` | 2.1.2 |
| `packages/input-shortcuts` | `@pi-unipi/input-shortcuts` | 2.1.2 |
| `packages/kanboard` | `@pi-unipi/kanboard` | 2.1.2 |
| `packages/mcp` | `@pi-unipi/mcp` | 2.1.2 |
| `packages/memory` | `@pi-unipi/memory` | 2.1.2 |
| `packages/milestone` | `@pi-unipi/milestone` | 2.1.2 |
| `packages/notify` | `@pi-unipi/notify` | 2.1.2 |
| `packages/ralph` | `@pi-unipi/ralph` | 2.1.2 |
| `packages/subagents` | `@pi-unipi/subagents` | 2.1.2 |
| `packages/updater` | `@pi-unipi/updater` | 2.1.2 |
| `packages/utility` | `@pi-unipi/utility` | 2.1.2 |
| `packages/web-api` | `@pi-unipi/web-api` | 2.1.2 |
| `packages/workflow` | `@pi-unipi/workflow` | 2.1.2 |
| `packages/unipi` | `@pi-unipi/unipi` (root) | 2.1.2 |
