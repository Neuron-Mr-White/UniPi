...
```
the research step <string(greedy)>
```
...
| Aspect | `the research step` | `the context-gathering step` |
|--------|-------------------|-------------------------|
