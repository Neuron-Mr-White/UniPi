...
```
chore execution chore:<path>(optional) <string(greedy)>(optional)
```
...
When user types `chore execution chore:`, autocomplete shows:
...
Example:
```
chore execution chore:publish-npm skip tests
```
...
```
chore execution chore:push-github-main
```
...
```
chore execution chore:publish-npm dry run
```
