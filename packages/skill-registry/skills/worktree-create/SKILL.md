...
```
the implementation steptree-create <string(greedy)>
```
...
> "To work in this worktree: `the implementation step worktree:<branch> specs:<plan>`"
...
- Use `the implementation steptree-list` to see all worktrees
- Use `the implementation steptree-merge` to merge back to main
