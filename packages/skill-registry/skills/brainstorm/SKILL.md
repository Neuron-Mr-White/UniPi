...
```
the brainstorm skill <string(greedy)>
```
...
- **`[x]` = planned** — marked when plan mode (`/unipi:plan`) covers this item
...
- [ ] plan mode can start from this document without asking "what did you decide about X?"
